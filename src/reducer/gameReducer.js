...
import { 
    ADD_TO_HISTORY, ADD_WINNER, UPDATE_NEXT_MOVE, 
    UPDATE_PLAYERS_INFO, CLEAR_HISTORY, CLEAR_HISTORY_BY_INDEX, 
    UPDATE_GAME_END, UPDATE_GAME_START, UPDATE_WINNERS_LIST
} from '../actions';
